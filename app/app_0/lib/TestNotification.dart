              ...
              child: Center(
                child: Column(
                  children: <Widget>[
                    ...
                    PaddedRaisedButton(
                      buttonText:
                          '按照当地时间安排，每周周一上午10:00:00通知',
                      onPressed: () async {
                        await _scheduleWeeklyMondayTenAMNotification();
                      },
                    ),
                    PaddedRaisedButton(
                      buttonText: '显示没有声音的通知',
                      onPressed: () async {
