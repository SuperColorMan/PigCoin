...
import 'package:xhd_app/view/widget/reply/HotReplyReplyItem.dart';
...
/// Des: 全局评论条目显示下方抽屉
/// -------------------------------
class GlobalCommentDrawerBox {
  /// 打开回复区域
  /// m 回复的评论信息
  static void openReplyArea(BuildContext context, Map m) {
    /// ---------------------------- 滚动特性 start ----------------------------
    ...
    /// 评论id
    String _commentId = "m['id'].toString()";

    /// 图片处理
    List<Map> _imgInfoList = List();
