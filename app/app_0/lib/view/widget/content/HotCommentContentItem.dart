...
/// ---------------------------------------------------------------------------------------------
/// Des: 构建热门评论以内容条目项形式的结构生成,上方是评论内容,下方是被评论的内容,注意:此时该内容结构中必须包含评论信息
/// ---------------------------------------------------------------------------------------------
class HotCommentContentItem extends StatefulWidget {
  Map contentStructure;

  HotCommentContentItem(this.contentStructure, {Key key}) : super(key: key);

  @override
  _HotCommentContentItemState createState() {
    return _HotCommentContentItemState();
  }
}

class _HotCommentContentItemState extends State<HotCommentContentItem> {
  @override
