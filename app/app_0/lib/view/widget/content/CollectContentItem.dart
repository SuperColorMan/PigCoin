...
/// --------------------------------------------------------------------------------------------------
/// Des: 构建收藏内容项,上方是收藏提示,下方是被收藏的内容(该结构一般用于的用户的通知消息提示内)
/// --------------------------------------------------------------------------------------------------
class CollectContentItem extends StatefulWidget {
  Map contentStructure;

  CollectContentItem(this.contentStructure, {Key key}) : super(key: key);

  @override
  _CollectContentItemState createState() {
    return _CollectContentItemState();
  }
}

class _CollectContentItemState extends State<CollectContentItem> {
  @override
