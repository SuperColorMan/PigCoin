...
/// -------------------------------------------------
/// Des: 构建内容项,包含排名索引标识符,例如金牌,银牌,铜牌
/// -------------------------------------------------
class HotCommentContentItemAddHotCommentTag extends StatefulWidget {
  Map contentStructure;

  HotCommentContentItemAddHotCommentTag(this.contentStructure, {Key key}) : super(key: key);

  @override
  _HotCommentContentItemAddHotCommentTagState createState() {
    return _HotCommentContentItemAddHotCommentTagState();
  }
}

class _HotCommentContentItemAddHotCommentTagState extends State<HotCommentContentItemAddHotCommentTag> {
  @override
                  ...
                  child: Expanded(
                    child: Row(
                      children: [
                        ClipOval(
                          child: CachedNetworkImage(
                            imageUrl: GlobalApiUrlTable.GET_USER_HEAD_PIC +
                                "?id=" +
                                userId +
                                '&${GlobalDateUtil.getCurrentTimestamp()}',
                            fit: BoxFit.fill,
                            width: 38,
                            height: 38,
                            placeholder: (context, url) => BallBeatIndicator(
                                      ...
                                      children: [
                                        WidgetSpan(
                                          child: ExtendedText(
                                            ...
                                            specialTextSpanBuilder: GlobalConst
