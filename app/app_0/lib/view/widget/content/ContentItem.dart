    ...
    List<Widget> userInfoList = [
      ...
      Container(
          constraints: BoxConstraints(
              maxWidth: ScreenUtil.getInstance().screenWidth * 0.45),
          padding: EdgeInsets.only(left: 10),
          child: Text(
            '${userName}qwejriojqwioejrqjiwoerjoqjwieorjioqjwoierjiojasiodfjioajsidofjioqwer',
...
//      )
    ...
    /// 互动按钮列表
    List<Widget> interactionBtnList = [
      /// 点赞按钮
      Expanded(
        child: LikeButton(
          isLiked: isGood,
          ...
          likeCount:
              tcInteractionInfo != null ? tcInteractionInfo['goodCount'] : 0,
          ...
          bubblesColor: BubblesColor(
            dotPrimaryColor: Color(GlobalColor.GOOD_PITCH_ON_TRAN_COLOR),
            dotSecondaryColor: Color(GlobalColor.GOOD_PITCH_ON_COLOR),
          ),
        ),
      ),
      ...
      Expanded(
        child: LikeButton(
          ...
          likeCount:
              tcInteractionInfo != null ? tcInteractionInfo['dissCount'] : 0,
          countPostion: CountPostion.bottom,
          likeBuilder: (bool isLiked) {
            return Icon(
...
//      ),
      ...
      Expanded(
        child: LikeButton(
          ...
          likeCount:
              tcInteractionInfo != null ? tcInteractionInfo['collCount'] : 0,
          countPostion: CountPostion.bottom,
          likeBuilder: (bool isLiked) {
            return Icon(
              Icons.star_border,
          ...
          bubblesColor: BubblesColor(
            dotPrimaryColor: Color(GlobalColor.COLL_PITCH_ON_TRAN_COLOR),
            dotSecondaryColor: Color(GlobalColor.COLL_PITCH_ON_COLOR),
          ),
        ),
      ),
    ];
