...
class HotReplyCommentItem extends StatefulWidget {
  Map replyStructure;
  Function callBack;

  HotReplyCommentItem(this.replyStructure, {Key key, this.callBack})
      : super(key: key);

  @override
  _HotReplyCommentItemState createState() {
    return _HotReplyCommentItemState();
  }
}

class _HotReplyCommentItemState extends State<HotReplyCommentItem> {
  @override
