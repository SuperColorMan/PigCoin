...
class CommoditySharePage extends StatefulWidget {
  CommoditySharePage({Key key}) : super(key: key);

  @override
  _CommoditySharePageState createState() => _CommoditySharePageState();
}

//页面状态配置,用于动态修改页面数据,页面事件等。
class _CommoditySharePageState extends State<CommoditySharePage> {
