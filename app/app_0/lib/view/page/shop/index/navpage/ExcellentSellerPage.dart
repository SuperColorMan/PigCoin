...
class ExcellentSellerPage extends StatefulWidget {
  ExcellentSellerPage({Key key}) : super(key: key);

  @override
  _ExcellentSellerPageState createState() => _ExcellentSellerPageState();
}

//页面状态配置,用于动态修改页面数据,页面事件等。
class _ExcellentSellerPageState extends State<ExcellentSellerPage> {
