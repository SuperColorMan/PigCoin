...
class BuyUserEveryDayPage extends StatefulWidget {
  BuyUserEveryDayPage({Key key}) : super(key: key);

  @override
  _BuyUserEveryDayPageState createState() => _BuyUserEveryDayPageState();
}

//页面状态配置,用于动态修改页面数据,页面事件等。
class _BuyUserEveryDayPageState extends State<BuyUserEveryDayPage> {
