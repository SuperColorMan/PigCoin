...
class NewCommodityPage extends StatefulWidget {
  NewCommodityPage({Key key}) : super(key: key);

  @override
  _NewCommodityPageState createState() => _NewCommodityPageState();
}

//页面状态配置,用于动态修改页面数据,页面事件等。
class _NewCommodityPageState extends State<NewCommodityPage> {
