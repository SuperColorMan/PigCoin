...
class AttentinoPage extends StatefulWidget {
  AttentinoPage({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _AttentinoPageState createState() => _AttentinoPageState();
}

class _AttentinoPageState extends State<AttentinoPage> {
  List imgList = [
